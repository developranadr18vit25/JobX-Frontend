...
function JobCard({Role, CompanyName, Location , JobType , Experience}) {
    return (

        <div className="bg-neutral-primary-soft block w-[70%] h-[35%] mt-[3%] p-6 border-2  rounded-4xl rounded-base shadow-xs">
